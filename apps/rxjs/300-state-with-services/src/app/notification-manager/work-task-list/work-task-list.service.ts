...
export class WorkTaskListService {
  ...
  setWorkTask(task: string, complete: boolean) {
    // Update state by assigning a new array for _todo and _done, and then
    // assign task to the appropriate list
    ...
    // Notify any consumers of the todo list state of changes to both lists
